...
fun getFileSize(uri: Uri): Long {
    NTKCryptApp.instance.contentResolver.query(
        uri,
...
fun getFileName(uri: Uri): String {
    ...
    NTKCryptApp.instance.contentResolver.query(uri, null, null, null, null)?.use { cursor ->
...
fun getImageAspectRatio(uri: Uri): Float? {
    val currentService = NTKCryptApp.instance
    return try {
