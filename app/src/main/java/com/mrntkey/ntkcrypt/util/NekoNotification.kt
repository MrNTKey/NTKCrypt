...
// 用于创建通知的对象
object NTKCryptNotification {

    const val NEKO_NOTIFICATION_ID = 20040821
    private const val CHANNEL_ID = "NTKCryptKeepAlive"
    private const val CHANNEL_NAME = "NTKCrypt 服务状态"
    ...
    fun createChannel(context: Context) {
        val channel = NotificationChannel(
            ...
            description = "用于保持NTKCrypt服务在后台稳定运行"
    ...
    fun build(context: Context): Notification {
        return NotificationCompat.Builder(context, CHANNEL_ID)
            .setContentTitle("NTKCrypt 正在守护中")
